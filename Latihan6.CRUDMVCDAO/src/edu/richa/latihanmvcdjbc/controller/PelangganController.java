 ...
 */
package edu.richa.latihanmvcdjbc.controller;

import edu.richa.latihanmvcdjbc.model.PelangganModel; 
import edu.richa.latihanmvcdjbc.view.PelangganView;
    ...
    public void insertPelanggan(PelangganView view){
        ...
        if (nama.trim().equals("")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(view,"Pealnggan Berhsil Ditambahkan");
                model.resetPelanggan();
       ...
       String nama = view.getTxtNama().getText();
        ...
        if (nama.trim().equals("")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(view,"Pealnggan Berhsil Di Ubah");
                model.resetPelanggan();
            } catch (Throwable throwable) {
         ...
         if (view.getTablePelanggan().getSelectedRowCount() == 0) {    
            ...
            if (JOptionPane.showConfirmDialog(view,"Anda yakin akan menghapus?")==JOptionPane.OK_OPTION) {
                ...
                JOptionPane.showMessageDialog(view,"Pealnggan Berhsil Di Hapus");
                model.resetPelanggan();
            } catch (Throwable throwable) {   
                 JOptionPane.showMessageDialog(view, new Object[]{"Terjadi Error di database dengan pesan", throwable.getMessage()});
            }
